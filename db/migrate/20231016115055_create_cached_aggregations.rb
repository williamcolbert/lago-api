...
class CreateCachedAggregations < ActiveRecord::Migration[7.0]
  def change
    create_table :cached_aggregations, id: :uuid do |t|
      ...
      t.references :billable_metric, type: :uuid, null: false, index: true
      ...
      t.index %i[organization_id timestamp billable_metric_id], name: 'index_timestamp_lookup'
      t.index %i[organization_id timestamp billable_metric_id group_id], name: 'index_timestamp_group_lookup'
    end
  end
end
